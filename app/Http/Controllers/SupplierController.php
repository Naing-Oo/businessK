...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $lims_supplier_data = $request->except(['image', 'id_card', 'document']);
        ...
        if ($id_card) {
            $ext = pathinfo($id_card->getClientOriginalName(), PATHINFO_EXTENSION);
            $idCardName = preg_replace('/[^a-zA-Z0-9]/', '', $request['company_name']);
            $idCardName = $idCardName . '-idcard.' . $ext;
            $id_card->move('storage/images/supplier', $idCardName);
            $lims_supplier_data['id_card'] = $idCardName;
        }
        ...
        if ($document) {
            ...
            $document->move('storage/documents/purchase', $documentName);
            $lims_supplier_data['document'] = $documentName;
        }
