...
class BillerController extends Controller
{
    ...
    public function store(Request $request)
    {
    	$this->validate($request, [
            ...
            'id_card' => 'image|mimes:jpg,jpeg,png,gif|max:10000',

        ]);

        $lims_biller_data = $request->except(['image', 'id_card']);
        ...
        if ($image) {
            ...
            $image->move('storage/images/biller', $imageName);
        ...
        if ($id_card) {
            ...
            $id_card->move('storage/images/biller', $idCardName);
            
            $lims_biller_data['id_card'] = $idCardName;
        }
