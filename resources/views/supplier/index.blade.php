        ...
        <table id="supplier-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{ trans('file.Credit Term') }}</th>
                    <th>{{ trans('file.Bank Account') }}</th>
            ...
            <tbody>
                ...
                <tr data-id="{{$supplier->id}}">
                    <td>{{$key}}</td>
                    @if($supplier->image)
                    <td> <img src="{{url('storage/images/supplier',$supplier->image)}}" height="80" width="80">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
           ...
           <p>{{trans('file.To display Image it must be stored in')}} storage/images/supplier {{trans('file.directory')}}</p>
	        <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="storage/sample_file/sample_supplier.csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i> {{trans('file.Download')}}</a>
                    </div>
                </div>
            </div>
