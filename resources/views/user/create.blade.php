                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'user.store', 'method' => 'post', 'files' => true]) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 staff-section" id="biller-id">
                                    ...
                                    <div class="form-group col-md-4 staff-section" id="warehouseId">
                                    ...
                                    <div class="form-group col-md-4 customer-section">
                                ...
                                <div class="customer-section">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label><strong>{{trans('file.Credit Term')}}</strong></label>
                                            <input type="text" name="credit_term" class="form-control">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label><strong>{{trans('file.Salesman')}}</strong></label>
...
<script type="text/javascript">
    ...
    $('select[name="role_id"]').on('change', function() {
        ...
        else if($(this).val() > 2 && $(this).val() != 5) { // staff
            $('select[name="warehouse_id"]').prop('required',false);
            $('select[name="biller_id"]').prop('required',false);
            $('#biller-id').show(300);
