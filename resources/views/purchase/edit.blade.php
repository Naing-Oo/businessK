                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="agent_id_hidden" value="{{ $lims_purchase_data->agent_id }}" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="catcher_id_hidden" value="{{ $lims_purchase_data->catcher_id }}" />
                                ...
                                <div class="row">
                                    <div id="purchase_date" class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="purchase_date" class="form-control" value="{{ $lims_purchase_data->purchase_date }}" required/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div id="queue_date" class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="queue_date" class="form-control" value="{{ $lims_purchase_data->queue_date }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div id="recieved_date" class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="recieved_date" class="form-control" value="{{ $lims_purchase_data->recieved_date }}" />
                                        </div>
                                    </div>
                                    <div id="due_date" class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="due_date" class="form-control" value="{{ $lims_purchase_data->due_date }}" />
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="recieved-actual-qty"><input type="number" class="form-control actual_qty" name="actual_qty[]" value="{{$product_purchase->actual_qty}}" step="any" required /></td>
                                                        <td class="recieved-round-qty"><input type="number" class="form-control round_qty" name="round_qty[]" value="{{$product_purchase->round_qty}}" step="any" required /></td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-actual-qty" class="recieved-actual-qty d-none">{{$lims_purchase_data->total_actual_qty}}</th>
                                                    <th id="total-round-qty" class="recieved-round-qty d-none">{{$lims_purchase_data->total_round_qty}}</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_actual_qty" value="{{$lims_purchase_data->total_actual_qty}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_round_qty" value="{{$lims_purchase_data->total_round_qty}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="agent_commission_rate" value="{{$lims_purchase_data->agent_commission_rate}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="catcher_commission_rate" value="{{$lims_purchase_data->catcher_commission_rate}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="agent_commission" class="form-control" step="any" value="{{$lims_purchase_data->agent_commission}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="catcher_commission" class="form-control" step="any" value="{{$lims_purchase_data->catcher_commission}}" />
                                        </div>
                                    </div>
                                    <?php 
                                        $attr = "";
                                        $diff_qty = $lims_purchase_data->diff_qty;
                                        if (($diff_qty >= 500) || ($diff_qty <= -500)){
                                            $attr = 'style=background-color:red;color:white;';
                                        }
                                        else {
                                            $attr = 'style=background-color:yellow;color:black;';
                                        }
                                    ?>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="diff_qty" class="form-control" step="any" value="{{$lims_purchase_data->diff_qty}}" {{$attr}} disabled/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-none">
                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    var Load_status = $('input[name="status_hidden"]').val();
    if (Load_status == '1' || Load_status == '2'){
        $('input[name="purchase_date"]').prop('disabled', true);
        ...
        $('input[name="purchase_date"]').prop('disabled', false);
        $('input[name="queue_date"]').prop('disabled', true);
        $('input[name="queue_date"]').prop('required', false);
        $('input[name="recieved_date"]').prop('disabled', true);
        $('input[name="due_date"]').prop('disabled', true);
    ...
    //assigning select value
    $('select[name="supplier_id"]').val($('input[name="supplier_id_hidden"]').val());
    $('select[name="warehouse_id"]').val($('input[name="warehouse_id_hidden"]').val());
    $('select[name="agent_id"]').val($('input[name="agent_id_hidden"]').val());
    $('select[name="catcher_id"]').val($('input[name="catcher_id_hidden"]').val());
    ...
    $('select[name="status"]').on('change', function() {
        ...
        else if(($('select[name="status"]').val() == 6)){
            $(".recieved-product-qty").addClass("d-none");
            $(".recieved-actual-qty").addClass("d-none");
            $(".recieved-round-qty").addClass("d-none");
            $('input[name="queue_date"]').prop('required', true);
